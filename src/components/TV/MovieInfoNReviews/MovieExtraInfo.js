            ...
            <div className="columnA">
                ...
                <div className="financesContainer">
                    <div className="financesItems">
                        <div className="extraInfoDetailContainer"><p>{`First Aired: ${new Date(movie.first_air_date).toLocaleDateString()}`}</p></div>
                    ...
                    <div className="extraInfoDetailContainer"><p>{movie.status}</p></div>
